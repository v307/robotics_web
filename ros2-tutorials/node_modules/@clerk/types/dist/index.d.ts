...
interface CommerceBillingNamespace {
     ...
     * ```
     */
    getSubscriptions: (params: GetSubscriptionsParams) => Promise<ClerkPaginatedResponse<CommerceSubscriptionItemResource>>;
    /**
     * @experimental This is an experimental API for the Billing feature that is available under a public beta, and the API is subject to change.
     * It is advised to pin the SDK version and the clerk-js version to a specific version to avoid breaking changes.
     * @example
 ...
 * ```
 */
interface CommercePayerResource extends ClerkResource {
    /**
     * @experimental This is an experimental API for the Billing feature that is available under a public beta, and the API is subject to change.
     * It is advised to pin the SDK version and the clerk-js version to a specific version to avoid breaking changes.
     * @example
...
interface SignInFutureEmailCodeSendParams {
    email: string;
}
...
interface SignInFuturePhoneCodeSendParams {
    phoneNumber?: string;
    channel?: PhoneCodeChannel;
}
 ...
 * ```
 */
interface CommerceSubscriptionItemJSON extends ClerkResourceJSON {
 ...
 * ```
 */
interface CommercePayerJSON extends ClerkResourceJSON {
...
interface SignUpFutureCreateParams {
    transfer?: boolean;
}
interface SignUpFutureEmailCodeVerifyParams {
    code: string;
}
type SignUpFuturePasswordParams = {
    emailAddress: string;
    password: string;
    phoneNumber?: never;
} | {
